...
import qualified Language.Alonzo.Transform.ANF      as Anf
import qualified Language.Alonzo.Transform.Abstract as Abs
...
storeClosures cls = do
  -- Merge closures into one, transform into a-normal form 
