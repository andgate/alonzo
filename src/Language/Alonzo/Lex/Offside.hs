{-# LANGUAGE FlexibleContexts
           ...
           , GADTs
  #-}
module Language.Alonzo.Lex.Offside where
...
mkCellOpenTok (Cell p ty) fp =
  case ty of
      Block -> Token TokenBlockOpen "" loc
      Frame -> Token TokenBlockOpen "" loc
      LineFold -> Token TokenLineOpen "" loc
...
mkCellCloseTok (Cell p ty) fp =
  case ty of
      Block -> Token TokenBlockClose "" loc
      Frame -> Token TokenBlockClose "" loc
      LineFold -> Token TokenLineClose "" loc
  where loc = Loc fp (R p p)
